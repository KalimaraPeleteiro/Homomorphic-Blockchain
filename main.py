...
def run_blockchain_tests():
    configs = [
        ...
        {'difficulty': 4, 'num_blocks': 5, 'transactions_per_block': 5},
        {'difficulty': 4, 'num_blocks': 10, 'transactions_per_block': 10},
        {'difficulty': 4, 'num_blocks': 10, 'transactions_per_block': 20},
        {'difficulty': 4, 'num_blocks': 20, 'transactions_per_block': 10},
        {'difficulty': 4, 'num_blocks': 20, 'transactions_per_block': 20},
    ]
